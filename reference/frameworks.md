...
For EACH framework below, perform DEEP analysis. Not a checklist — actual exploration.

**Minimum:** 200 words per framework. Generate R### tasks for any gaps identified.

---

## PART A: Core Investigation Frameworks (1-20)
...
- Who gains if our conclusions are wrong?
...
**What sequence of events matters?**

- What sequence would change the interpretation?
...
**What paper trail exists or should exist?**
...
- What informal networks might be relevant?
...
### 14. Pre-Mortem
**If this investigation fails, why?**
...
## PART B: Domain Expertise Frameworks (21-25)

**Purpose:** Prevent surface-level analysis that misses what experts consider obvious.
...
**Required:** Peer-reviewed journals, academic textbooks, scientific reviews

### 22. Domain Expert Blind Spots
**What would an expert consider obvious that we're missing?**

- Who are the domain experts for this topic?
...
**Action:** Search for "What do [domain experts] consider obvious about [topic] that journalists typically miss?"

### 23. Marketing vs Scientific Reality
**Where do claims diverge from evidence?**

- What does marketing/PR say vs what does research show?
- What terms have marketing definitions vs scientific definitions?
...
- For animals: What do ethological studies show about their preferences?
- For people: What do affected individuals actually report?
- For systems: What do operational metrics actually show?
- Are we taking the subject's perspective or only the claimant's?
- What would we find if we directly observed/measured the subject?

### 25. Contrarian Expert Search
**Who disagrees with the mainstream view?**
...
**Action:** Search for "[topic] criticism", "[topic] problems", "[topic] myth debunked"

---

## PART C: Analytical Rigor Frameworks (26-30)

**Purpose:** Prevent superficial analysis by requiring quantitative and methodological standards.
...
- What's the denominator? ("10 cases" means nothing without "out of how many")

**Key test:** If we quantified every claim, would the story change?
...
**Red flags:** "Associated with" treated as "causes"; post hoc reasoning
...
**Example:** "Violence," "safe," "natural," "effective" can be defined to support different conclusions
...
**Check for:** Self-reported data bias, survey framing, observational confounders
...
**Principle:** When behavior seems irrational, look for hidden incentives

---

## PART D: Structural Analysis Frameworks (31-35)

**Purpose:** Examine systemic and structural factors often missed in surface-level analysis.
...
**Key question:** Who benefits from public ignorance?
...
**Danger:** Cherry-picking favorable comparisons. Actively seek unfavorable ones.
...
**Indicators:** Regulations favoring incumbents, enforcement targeting small players, industry insiders on advisory boards
...
**Red flags:** "Studies show..." without citations, circular citation, single anonymous sources
...
**Principle:** If you can't explain HOW something works step by step, you don't understand it
...
**Total:** X/35 frameworks completed
